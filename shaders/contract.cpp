...
BEAM_EXPORT void Method_3(const method::CreateRepo& params) {  // NOLINT
...
BEAM_EXPORT void Method_4(const method::DeleteRepo& params) {  // NOLINT
...
BEAM_EXPORT void Method_5(const method::AddUser& params) {  // NOLINT
  std::unique_ptr<RepoInfo> repo_info = LoadRepo(params.repo_id);
...
BEAM_EXPORT void Method_6(const method::RemoveUser& params) {  // NOLINT
  std::unique_ptr<RepoInfo> repo_info = LoadRepo(params.repo_id);
...
BEAM_EXPORT void Method_7(const method::PushObjects& params) {  // NOLINT
  std::unique_ptr<RepoInfo> repo_info = LoadRepo(params.repo_id);
...
BEAM_EXPORT void Method_8(const method::PushRefs& params) {  // NOLINT
  std::unique_ptr<RepoInfo> repo_info = LoadRepo(params.repo_id);
