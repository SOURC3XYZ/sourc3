...
import { defaultValue } from '@libs/redux/reducers/profiles.reducer';
...
function GitProfile() {
  ...
  }, setGitHubProfile] = useState(defaultValue);
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          <div className={styles.side}>
            ...
            <Organizations githubOrgs={github_orgs} />
          </div>
          <div className={styles.main}>
            ...
            <GitOwnRepos data={github_owned_repos} />
          </div>
        </div>
      </div>
      <Popup
